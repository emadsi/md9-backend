...
public class JwtFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        List<String> protectedPaths = List.of(
                ...
                "/api/admins/register",
                "/api/admins/", // to catch /api/admins/{username}
        ...
        boolean requiresAuth = protectedPaths.stream().anyMatch(path::startsWith);
        ...
        // || path.equals("/api/reservations/create")
        ...
        try {
            ...
            if (username != null && SecurityContextHolder.getContext().getAuthentication() == null) {
                ...
                System.out.println("[JwtFilter] ✅ Loaded user details: " + userDetails.getUsername()); // Logging
                                                                                                       // userDetails

                if (jwtUtil.isTokenValid(token, userDetails)) {
                    System.out.println("[JwtFilter] ✅ Token is valid for user: " + username); // Logging Token
                                                                                              // Validation for user
                    System.out.println("[JwtFilter] ✅ Authorities: " + userDetails.getAuthorities()); // Logging
                                                                                                      // Authorities
                    ...
                    System.out.println("[JwtFilter] ✅ Authentication set in security context"); // Logging
                                                                                                // Authentication
                                                                                                // setting
                } else {
